...
InsightAPI.prototype.setupRoutes = function(app) {
  ...
  app.get('/assets/restrictions', this.cacheShort(), assets.listGlobalRestrictions.bind(assets));
  app.get('/asset/:asset/verifier', this.cacheShort(), assets.getVerifierString.bind(assets));
  app.get('/asset/:asset/checkRestriction', this.cacheShort(), assets.checkRestriction.bind(assets));
  ...
  app.get('/addr/:addr/restrictions', this.cacheShort(), addresses.checkAddr.bind(addresses), addresses.restrictionsForAddress.bind(addresses));
  app.get('/addr/:addr/checkRestriction/asset/:asset', this.cacheShort(), addresses.checkAddr.bind(addresses), addresses.checkRestriction.bind(addresses));
