...
AddressController.prototype.restrictionsForAddress = function(req, res) {
  var self = this;
  ...
  this.node.listAddressRestrictions(address, function(err, data) {
    if (err) {
      return self.common.handleErrors(err, res);
    }
...
AddressController.prototype.checkRestriction = function(req, res) {
  var self = this;
