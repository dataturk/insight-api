...
AssetController.prototype.listGlobalRestrictions = function(req, res) {
    var self = this;

    this.node.listGlobalRestrictions(function(err, data) {
        if (err) {
            return self.common.handleErrors(err, res);
        }
...
AssetController.prototype.checkRestriction = function(req, res) {
    var self = this;
    ...
    var restrictions = this.node.listGlobalRestrictions(function(err, data) {
        if (err) {
            return self.common.handleErrors(err, res);
        }
